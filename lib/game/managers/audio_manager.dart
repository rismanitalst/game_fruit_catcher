...
class AudioManager {
  ...
  /// Initializw audio system - preload all audio files
  Future<void> initialize() async{
    try {
      //Preaload all sound effect
...
/// Play background music
  ...
  void pauseBackgroundMusic() { 
    try { 
      ...
      log('Error pausing background music: $e'); 
    } 
  }
  ...
  void resumeBackgroundMusic() { 
    if (_isMusicEnabled) { 
      try { 
        ...
        log('Error resuming background music: $e'); 
      } 
    } 
  }
  ...
  void playSfxWithVolume(String fileName, double volume) { 
    if (_isSfxEnabled) { 
      try { 
        ...
        log('Error playing SFX with volume: $e'); 
      } 
    } 
  }
  ...
  void setMusicVolume(double volume) { 
    ...
    try { 
      ...
      log('Error setting music volume: $e'); 
    } 
  }
